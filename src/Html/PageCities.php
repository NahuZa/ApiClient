...
class PageCities
{
    public static function render(array $counties, array $cities = [], ?int $selectedCountyId = null, ?string $filterLetter = null)
    {
        ...
        if ($selectedCountyId) {
            self::Abcbuttons($cities, $selectedCountyId);
        }

        self::Cities($filteredCities, $selectedCountyId);
    }
    ...
    private static function renderSearchCityBar()
    {
        ...
        <form method="post" action="">
            <input type="text" name="keyword" placeholder="Város alapú keresés" required />
    ...
    private static function Abcbuttons(array $cities, ?int $selectedCountyId)
    {
    ...
    public static function Cities(array $cities, ?int $selectedCountyId)
    {
